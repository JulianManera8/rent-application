          ...
          <CardContent>
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                { icon: Calendar, label: "Finalizacion del Usufructo", key: "finalizacion_usufructo", type: "date" },
                { icon: Calendar, label: "Inicio del contrato", key: "inicio_contrato", type: "date" },
                { icon: Calendar, label: "Finalizacion del contrato", key: "finalizacion_contrato", type: "date" },
