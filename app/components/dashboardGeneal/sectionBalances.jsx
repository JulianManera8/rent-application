...
export default function SectionPropiedades() {
    return (
        <div>
            <h1 className="text-3xl font-extrabold text-[#0c426bd3] mb-3"> Balances </h1>
            ...
            <div className="flex gap-x-10 max-h-64">
                ...
                <Card className="border-1 shadow-md shadow-black/15 border-[0.6px] border-t-[1px] w-[410px] flex flex-col justify-evenly">
                    <CardHeader className="flex flex-row items-center justify-start w-full space-y-0 py-3 mb-2 h-1/3">
                        ...
                        <FileChartColumnIcon className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent className="space-y-3">
                        <div className="flex items-center text-sm font-bold gap-x-4 w-full ">
                            <span className="w-7/12 font-extralight text-zinc-600 overflow-hidden whitespace-nowrap text-ellipsis"> Familia Manera </span> 
                        ...
                        <div className="flex items-center text-sm font-bold gap-x-4 w-full ">
                            <span className="w-7/12 font-extralight text-zinc-600 overflow-hidden whitespace-nowrap text-ellipsis"> Perez </span> 
                            <div className="flex items-center justify-end w-fit space-x-2">
                                <span className="text-sm w-max font-bold">
                                    Abril, 2024
                                </span>
                        ...
                        <div className="flex items-center text-sm font-bold gap-x-4 w-full ">
                            <span className="w-7/12 font-extralight text-zinc-600 overflow-hidden whitespace-nowrap text-ellipsis"> M&N Asociados </span> 
                            <div className="flex items-center justify-end w-fit space-x-2">
                                <span className="text-sm w-max font-bold">
                                    Marzo, 2024
                                </span>
