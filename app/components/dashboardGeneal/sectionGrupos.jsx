            ...
            <div className="flex gap-x-10 ">
                ...
                <div className=" space-y-4 flex flex-col justify-between">
                    <Card className="border-1 shadow-md shadow-black/15 border-[0.6px] border-t-[1px] w-64 min-h-[100px] flex flex-col justify-between">
                        <CardHeader className="flex flex-row items-center justify-start w-full space-y-0 py-2">
                            <CardTitle className="text-lg font-extrabold text-left w-full">Grupos Creados </CardTitle>
                            <Boxes className="h-5 w-5 text-muted-foreground" />
                        </CardHeader>
                        <CardContent className="flex flex-col justify-between">
                            <span className="text-lg text-zinc-600 font-bold"> 3 </span>
                ...
                <Card className="border-1 shadow-md shadow-black/15 border-[0.6px] border-t-[1px] w-[400px] flex flex-col justify-evenly">
                    <CardHeader className="flex flex-row items-center justify-start w-full space-y-0 py-1 h-1/3">
                        <CardTitle className="text-lg font-extrabold text-left w-full">Distribucion de Propiedades por Grupo</CardTitle>
                    ...
                    <CardContent className="space-y-3">
                        <div className="flex items-center text-sm font-bold gap-x-3 w-full ">
                            <span className="w-3/5 text-zinc-600 font-light overflow-hidden whitespace-nowrap text-ellipsis"> Familia Manera </span> 
                            <Progress className="w-4/5 text-blue-400" value={10} /> 
                            <span className="w-[36%] text-blue-400 flex-row flex items-center  text-xs"> 10% - 2/20 </span>
                        </div>

                        <div className="flex items-center text-sm font-bold gap-x-3 w-full ">
                            <span className="w-3/5 text-zinc-600 font-light overflow-hidden whitespace-nowrap text-ellipsis"> Perez </span> 
                            <Progress className="w-4/5 text-blue-400" value={50} /> 
                            <span className="w-[36%] text-blue-400 text-xs"> 50% - 10/20 </span>
                        </div>

                        <div className="flex items-center text-sm font-bold gap-x-3 w-full ">
                            <span className="w-3/5 text-zinc-600 font-light overflow-hidden whitespace-nowrap text-ellipsis"> M&N Asociados </span> 
                            <Progress className="w-4/5 text-blue-400" value={40} /> 
                            <span className="w-[36%] text-blue-400 text-xs"> 40% - 8/20 </span>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-1 shadow-md shadow-black/15 relative border-[0.6px] border-t-[1px] w-[400px] flex flex-row justify-evenly">
                    <div className="absolute top-0 left-0 w-56">
                        <h1 className="text-lg  font-extrabold flex text-left p-3 w-full items-center justify-center">Distribucion de Ingresos por Grupo</h1>
                    </div>
